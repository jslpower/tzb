...
namespace Enow.TZB.Web.Ashx
{
    ...
    public class GetVerCode : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string IsMustCheck = context.Request.QueryString["IsMustCheck"];
            bool IsMustSend = false;
            if (IsMustCheck == "1")
                IsMustSend = true;
            getVerCode(MobilePhone, IsMustSend);
            context.Response.End();
        }
        /// <summary>
        /// 获取注册验证码
        /// </summary>
        private void getVerCode(string MobilePhone, bool IsMustSend)
        {
