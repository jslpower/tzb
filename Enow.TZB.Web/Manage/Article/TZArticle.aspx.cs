...
{
    public partial class TZArticle : System.Web.UI.Page
    {
        // <summary>
        /// 每页条数
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                phadd.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.堂主日志新增);
                phupdate.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.堂主日志修改);
                phdelete.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.堂主日志删除);
            }
            InitList();
