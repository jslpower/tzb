<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" CodeBehind="DZArticle.aspx.cs" Inherits="Enow.TZB.Web.Manage.Article.DZArticle" %>
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                window.location.href = "DZArticle.aspx?Name=" + name + "";
            },
