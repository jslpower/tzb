<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="RegistrationList.aspx.cs" Inherits="Enow.TZB.Web.Manage.Court.RegistrationList" %>
                ...
                <table width="100%" id="liststyle">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td align="center">
                                    <input type="checkbox" name="checkbox" id="checkbox" data-title="<%#Eval("FieldName")%>" value="<%#Eval("AppId") %>" />
                                </td>
                                 <td align="center">
        ...
        var PageJsDataObj = {
            ...
            Update: function (objsstater) {
               var list = new Array();
                ...
                data.url += '/RegistrationList.aspx?';
                data.title = '修改场地报名状态';
                data.url += $.param({
                    sl: this.Query.sl,
                    MId:<%=Request.QueryString["MId"] %>,
            ...
            Search: function () {
                ...
                window.location.href = "RegistrationList.aspx?"+$.param(PageJsDataObj.Query)+"&Title=" + Title + "&staters=" + staters;
            },
            BindBtn: function () {
                //查看报名人数
                $(".Shtg").click(function() {
