<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CityEdit.aspx.cs" Inherits="Enow.TZB.Web.Manage.basic.CityEdit" %>
    ...
    <div class="contentbox">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableInfo">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCityName" CssClass="inputtext formsize240" runat="server">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCityName"
                        ErrorMessage="请填写城市名称！">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <th width="150" height="40" align="right">
