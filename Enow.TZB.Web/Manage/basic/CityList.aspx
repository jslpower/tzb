<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
 AutoEventWireup="true" CodeBehind="CityList.aspx.cs" Inherits="Enow.TZB.Web.Manage.basic.CityList" %>
 ...
 <div class="contentbox">
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    城市名称：
                  <input type="text" id="txtCityName" name="txtCityName" class="input-txt" value='<%=Enow.TZB.Utility.Utils.GetQueryStringValue("CityName")%>' />
                    &nbsp;&nbsp;
                ...
                <table width="100%" id="liststyle">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td align="center">
                                    <input type="checkbox" name="checkbox" id="checkbox" value="<%#Eval("CityId") %>" />
                                </td>
                                <td align="left">
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Delete: function (objsArr) {
                ...
                if (window.confirm("删除当前城市信息，会同步删除当前城市下区县信息，是否继续删除？")) {

                    var data = this.DataBoxy();
                    data.url += '/CityList.aspx?';
             ...
             Search: function () {
                ...
                window.location.href = "CityList.aspx?CityName=" + cityName + "";
                },
            BindBtn: function () {
                //添加
