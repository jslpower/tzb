<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="AreaList.aspx.cs" Inherits="Enow.TZB.Web.Manage.basic.AreaList" %>
    ...
    <div class="contentbox">
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    区县名称：
                    <input type="text" id="txtAreaName" name="txtAreaName" class="input-txt" value='<%=Enow.TZB.Utility.Utils.GetQueryStringValue("AreaName")%>' />
                    &nbsp;&nbsp;
                ...
                <table width="100%" id="liststyle">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <itemtemplate>
                            <tr>
                                <td align="center">
                                    <input type="checkbox" name="checkbox" id="checkbox" value="<%#Eval("CountyId") %>" />
                                </td>
                                <td align="left">
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                window.location.href = "AreaList.aspx?AreaName=" + areaName + "";
            },
            BindBtn: function () {
                //添加
