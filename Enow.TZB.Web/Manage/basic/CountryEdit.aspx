<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryEdit.aspx.cs" Inherits="Enow.TZB.Web.Manage.basic.CountryEdit" %>
    ...
    <div class="contentbox">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tableInfo">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCountryName" CssClass="inputtext formsize240" runat="server">
