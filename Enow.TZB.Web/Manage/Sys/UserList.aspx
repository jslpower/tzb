<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="Enow.TZB.Web.Manage.Sys.UserList" %>
    ...
    <div class="listbox">
      <div id="tablehead" class="tablehead">
        ...
        <li><s class="addicon"></s><a href="javascript:void(0)" hidefocus="true" class="toolbar_add add_gg">新增</a></li>
          <li class="line"></li>
          <li><s class="updateicon"></s><a href="#" hidefocus="true" class="toolbar_update">修改用户</a></li>
          <li class="line"></li>
      ...
      <ItemTemplate><tr>
            ...
            <td align="center"><%#GetRoleName(Eval("RoleId"))%></td>
            ...
            <td align="center"><a href="javascript:void(0)" class="transactions" data-rel='<%#Eval("Id") %>'>独立授权</a></td>
          </tr></ItemTemplate>
      </asp:Repeater>
