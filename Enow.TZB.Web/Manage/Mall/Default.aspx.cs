    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                PhAdd.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.培训商品新增);
                phupdate.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.培训商品修改);
                phdelete.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.培训商品删除);
                phstop.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.培训商品停售);
                phstart.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.培训商品恢复销售);
                GetRoleclass();
                InitList();
            }
        }
        ...
        private void InitList()
        {
            ...
            searchModel.TypeId = (int)Enow.TZB.Model.商品分类.培训课程;
        ...
        protected string InitStatus(string selectItem)
        {
            ...
            Strddl.Append("<option value='-1'>-请选择-</option>");
