...
{
    public partial class FootballGoods : System.Web.UI.Page
    {
        // <summary>
        /// 每页条数
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                PhAdd.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.足球旅游商品新增);
                phUpdate.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.足球旅游商品修改);
                phdelete.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.足球旅游商品删除);
                phstop.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.足球旅游商品停售);
                phstart.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.足球旅游商品恢复销售);
                GetRoleclass();
                InitList();
        ...
        private void InitList()
        {
            ...
            searchModel.TypeId = (int)Enow.TZB.Model.商品分类.足球旅游;
