<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Enow.TZB.Web.Manage.Mall.Default" %>
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                window.location.href = "Default.aspx?MId="+MId+"&SMId="+SMId+"&CId="+CId+"&Name=" + name + "&Status=" + Status + "&types=" + types;
            },
