<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="Auction.aspx.cs" Inherits="Enow.TZB.Web.Manage.Mall.Auction" %>
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Add: function () {
                ...
                data.url += '/AuctionGoodsEdit.aspx?';
                data.title = '新增商品';
                data.url += $.param({
                    sl: this.Query.sl,
                    doType: "Add"
            ...
            Search: function () {
                ...
                window.location.href = "Auction.aspx?MId="+MId+"&SMId="+SMId+"&CId="+CId+"&Name=" + name + "&Status=" + Status + "&types=" + types;
            },
