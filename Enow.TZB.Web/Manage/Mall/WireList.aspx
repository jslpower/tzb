<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="WireList.aspx.cs" Inherits="Enow.TZB.Web.Manage.Mall.WireList" %>
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                window.location.href = "WireList.aspxMId="+MId+"&SMId="+SMId+"&CId="+CId+"&Name=" + name + "&Status=" + Status + "&types=" + types;
            },
