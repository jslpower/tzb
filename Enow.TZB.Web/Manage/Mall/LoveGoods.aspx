<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="LoveGoods.aspx.cs" Inherits="Enow.TZB.Web.Manage.Mall.LoveGoods" %>
            ...
            <div id="tablehead" class="tablehead">
                <ul class="fixed">
                  <asp:PlaceHolder ID="PhAdd" runat="server" Visible="false">
                    ...
                    <li><s class="qiyicon"></s><a href="#" hidefocus="true" class="toolbar_start">恢复销售</a></li></asp:PlaceHolder>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td align="center">
                                 ...
                                 <td align="center">
                                    <%#(Enow.TZB.Model.义卖商品销售状态)int.Parse(Eval("Status").ToString())%>
                                </td>
                                 <td align="center">
                                    <%#Eval("MemberId")!=null?Getusname(Eval("MemberId").ToString()):""%>
                                </td>
                                <td align="center">
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                window.location.href = "LoveGoods.aspx?MId=" + MId + "&SMId=" + SMId + "&CId=" + CId + "&Name=" + name + "&Status=" + Status + "&types=" + types;
            },
