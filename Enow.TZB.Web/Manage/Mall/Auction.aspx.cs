    ...
    public partial class Auction : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                PhAdd.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.拍卖商品新增);
                phupdate.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.拍卖商品修改);
                phdelete.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.拍卖商品删除);
                phstop.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.拍卖商品停售);
                phstart.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.拍卖商品恢复销售);
                GetRoleclass();
                InitList();
        ...
        {
            var list = BRoleClass.GetTypeList(2);
            if (list.Count > 0)
            {
        ...
        private void InitList()
        {
            ...
            searchModel.TypeId = (int)Enow.TZB.Model.商品分类.公益拍卖;
