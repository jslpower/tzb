<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuctionGoodsEdit.aspx.cs" Inherits="Enow.TZB.Web.Manage.Mall.AuctionGoodsEdit" %>
            ...
            <table  width="100%" cellspacing="0" cellpadding="0" border="0" id="tableInfo">
               ...
               <tr>
                ...
                <tr id="trfreiht" >
                  <th width="100">运费：</th>
                  <td>
                   <asp:TextBox ID="txtFreightFee" runat="server" errmsg="运费只能为数字!" valid="isNumber" CssClass="inputtext formsize80" MaxLength="6"></asp:TextBox>&nbsp;元
                  </td>
                </tr>
                <tr>
                    <th width="100">
