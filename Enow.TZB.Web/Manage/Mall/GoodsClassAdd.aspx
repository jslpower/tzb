<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsClassAdd.aspx.cs" Inherits="Enow.TZB.Web.Manage.Mall.GoodsClassAdd" %>
    ...
    <div class="contentbox">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtTypeName" style=" width:100px" CssClass="input-txt formsize180" runat="server"></asp:TextBox><span
                        class="fontred">*</span>
