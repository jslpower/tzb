<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Enow.TZB.Web.Manage.Videocode.Default" %>
            ...
            <span class="searchT">
                <p>
                   ...
                   <input type="text" id="txtTitle" runat="server" name="txtTitle" class="input-txt" />
                    &nbsp;&nbsp;使用状态：
                    <select id="ddlIsValid" name="ddlIsValid" runat="server" class="inputselect">
            ...
            <div id="tablehead" class="tablehead">
                ...
                <li><s class="addicon"></s><a href="javascript:void(0)" hidefocus="true" class="toolbar_add add_gg">
                 ...
                 <asp:PlaceHolder ID="phUpdate" runat="server" Visible="false">
                    <li class="line"></li>
                    <li><s class="updateicon"></s><a href="#" hidefocus="true" class="toolbar_update">绑定</a></li>
                    </asp:PlaceHolder>
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <%#(Enow.TZB.Model.EnumType.VideoCodeEnum)(Enow.TZB.Utility.Utils.GetInt(Eval("Codetype").ToString()))%>
                                </td>
                                <td align="center">
                                    <%#Eval("Codenum")%>
                                </td>
                                <td align="center">
                                    <%#Eval("Codestate").ToString()=="0"?"未使用":"已使用"%>
                                </td>
                                <td align="center">
                                    <%#Eval("Usnc")%>
                                </td>
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                var states = $("#<%=ddlIsValid.ClientID %>").val();
                window.location.href = "Default.aspx?"+$.param(PageJsDataObj.Query)+"&Title=" + Title + "&types=" + types + "&states=" + states;
            },
            BindBtn: function () {
             //添加
