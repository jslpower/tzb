<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationDetail.aspx.cs"
    Inherits="Enow.TZB.Web.Manage.Match.RegistrationDetail" %>
        ...
        <div class="Basic_btn fixed">
            <ul>
             <li>
                 ...
                 <li>
                    <asp:LinkButton ID="linkBtnDisabled" runat="server" 
                         onclick="linkBtnDisabled_Click" >审核拒绝 >></asp:LinkButton>
                </li>
