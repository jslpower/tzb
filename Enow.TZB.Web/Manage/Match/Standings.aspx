<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="Standings.aspx.cs" Inherits="Enow.TZB.Web.Manage.Match.Standings" %>
    ...
    <div class="contentbox">
        ...
        <div class="listbox">
            <div id="tablehead" class="tablehead">
                <ul class="fixed">                    
                    <li><s class="addicon"></s><a href="#" hidefocus="true" class="toolbar_update">战报</a></li>
                    <li class="line"></li>
                </ul>
                <div class="pages">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <%#Eval("PublishState").ToString() == "1" ? "已发布" : "未发布"%>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        var PageJsDataObj = {
            ...
            Update: function (objsArr) {
                ...
                data.url += '/MatchScheduleResultAdd.aspx?';
                data.title = '战报信息录入';
                data.url += $.param({
                    sl: this.Query.sl,
                    MId:<%=Request.QueryString["MId"] %>,
            ...
            Search: function () {
                 var MatchName = escape($("#txtMatchName").val());
                    ...
                    url = "Standings.aspx?MatchName=" + MatchName + "&GameName=" + GameName + "&FieldName=" + FieldName + "&"+$.param(PageJsDataObj.Query);
