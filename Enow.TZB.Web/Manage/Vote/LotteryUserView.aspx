<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotteryUserView.aspx.cs" Inherits="Enow.TZB.Web.Manage.Vote.LotteryUserView" %>
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <%#Eval("CountryName")%><%#Eval("ProvinceName")%><%#Eval("CityName")%><%#Eval("AreaName")%><%#Eval("ContactName")%>
                                </td>
                                <td align="center">
                                    <%#Eval("UIndatetime")%>
                                </td>
