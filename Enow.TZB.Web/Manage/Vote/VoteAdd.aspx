<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="VoteAdd.aspx.cs" Inherits="Enow.TZB.Web.Manage.Vote.VoteAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="contentbox">
        <div class="firsttable">
            <span class="firsttableT">投票信息</span>            
        ...
        var PageJsDataObj = {
            ...
            submit: function () {
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "VoteAdd.aspx?dotype=save&" + $.param(PageJsDataObj.Data),
            ...
            Addtrp: function (Base) {
                ...
                strHtml += '<input name="OptionName" errmsg="请填写第' + PageJsDataObj.TrIndex + '个选项名称!" valid="required" type="text" value="' + (Base ? Base.Otitle : "") + '" />';
                strHtml += '投票数:';
                strHtml += '<input name="OptionNum" errmsg="请填写第' + PageJsDataObj.TrIndex + '个投票数!" valid="required" type="text" value="' + (Base ? Base.ONumber : "0") + '" />';
