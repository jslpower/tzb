<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Enow.TZB.Web.Manage.Vote.Default" %>
            ...
            <div id="tablehead" class="tablehead">
                <ul class="fixed">
                    ...
                    <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible="true">
                        <li class="line"></li>
                        <li><s class="delicon"></s><a href="#" hidefocus="true" class="Getbaoming">查看投票信息</a></li>
                        <li class="line"></li>
                    </asp:PlaceHolder>
                </ul>
                <div class="pages">
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                    <%#(Enow.TZB.Model.EnumType.VoteEnum)Enow.TZB.Utility.Utils.GetInt(Eval("Vtype").ToString(),1)%>
                                </td>
                                <td align="center">
                                    <%#Eval("Vtitle")%>
                                </td>
    ...
    <script type="text/javascript">
        var PageJsDataObj = {
            ...
            Search: function () {
                ...
                window.location.href = "Default.aspx?"+$.param(PageJsDataObj.Query)+"&Title=" + Title + "&fbmb="+fbmb+"&types="+types;
            },
            BindBtn: function () {
                //查看报名人数
