...
namespace Enow.TZB.Web.Manage.Vote
{
    public partial class LotteryList : System.Web.UI.Page
    {
        ...
        private void Getquanxian()
        {
            ...
            phadd.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.抽奖信息新增);
            phUpdate.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.抽奖信息修改);
            phdelete.Visible = ManageUserAuth.CheckAdminAuth((int)Model.RoleEnum.抽奖信息删除);
            //发布至
            ...
            var lxlist = EnumObj.GetList(typeof(Model.EnumType.VotecjEnum));
            if (lxlist != null)
            {
