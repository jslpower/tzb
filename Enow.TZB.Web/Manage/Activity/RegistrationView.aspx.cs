...
namespace Enow.TZB.Web.Manage.Activity
{
    public partial class RegistrationView : System.Web.UI.Page
    {
        ...
        public void Initload()
        {
            ...
            {
                hdlist.RemoveAt(0);
                hdlist.Insert(0, new EnumObj { Value = "-1", Text = "全部" });
            }
            droptype.DataSource = hdlist;
            droptype.DataBind();
            //报名状态
        ...
        private void InitPage()
        {
            ...
            var list = BApplicants.GetAppActUserList(ref rowCounts, intPageSize, CurrencyPage, codequery);
            if (rowCounts > 0)
            {
        ...
        public void Upstatertg(int staters)
        {
            ...
            bool bllRetCode = BApplicants.UpdateStater(id, staters);
            if (bllRetCode)
            {
