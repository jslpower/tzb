  ...
  <div class="msg_tab">
        ...
        <div class="TabContent">
			...
			<div id="n4Tab_Content0">
                ...
                <div class="msg_list">
                  <ul>
                            <li><label><asp:Literal ID="ltrAccountText" runat="server"></asp:Literal></label><asp:Literal ID="ltrUserName" runat="server"></asp:Literal> <!--<a href="" class="gai_btn">给好友充值</a>--></li>
