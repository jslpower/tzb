<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayPassword.aspx.cs" Inherits="Enow.TZB.Web.WX.Fund.PayPassword" %>
...
<div class="warp">
  ...
  <div class="msg_tab"  id="n4Tab">
        ...
        <div id="n4Tab_Content1">
                ...
                <div class="msg_list">
                  <ul>
                  <li><label>当前密码：</label><asp:TextBox ID="txtOldPassword" 
                          CssClass="formsize100 input_bk" runat="server" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator
                                    ID="RequiredFieldValidator3" runat="server" ErrorMessage="请填写当前密码!" 
                                    ControlToValidate="txtOldPassword">*</asp:RequiredFieldValidator></li>
                ...
                <div class="msg_btn">
                    <asp:Button ID="btnSave" runat="server" CssClass="basic_btn" Text="修改支付密码" 
                        onclick="btnSave_Click" />
                        <div class="clearfix"></div><br />
                        <asp:Button ID="btnReset" runat="server" CssClass="basic_ybtn" Text="找回支付密码" 
