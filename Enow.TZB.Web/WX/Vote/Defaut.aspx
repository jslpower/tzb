<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Defaut.aspx.cs" Inherits="Enow.TZB.Web.WX.Vote.Defaut" %>
        ...
        function pullUpAction() {
            setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
                ...
                if (pageEnd == "0") {
                    ...
                    if (title == "")
                        title = "";
                    var para = { title: title, Page: index, tzurl: "VoteInfo.aspx",types:1 };
                    $.ajax({
                        type: "Get",
        ...
        <div class="list-item" >
            <ul id="fiullist">
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                    <li class="R_jiantou" onclick="location.href='VoteInfo.aspx?Vid=<%#Eval("Vid")%>'"><%#Eval("Vtitle")%></li>
                    </ItemTemplate>
                </asp:Repeater>
            </ul>
