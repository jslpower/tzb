        ...
        private void InitMember(string OpenId)
        {
            ...
            if (model != null)
            {
                ...
                if (WeiXinModel != null)
                {
                    ...
                    {
                        Literal1.Text = "<div class=\"user-item user-item02 font14 R_jiantou\"><a href=\"/WX/Member/Articles.aspx?types="+model.Jobtyoe+"\"><i class=\"u-ico08\"></i>"+(Enow.TZB.Model.EnumType.JobType)Utils.GetInt(model.Jobtyoe.ToString())+"日志</a></div>";
                    }
