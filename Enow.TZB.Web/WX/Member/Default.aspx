...
<div class="user_warp paddB10">
    ...
    <div class="user-menu">
       <ul class="fixed">
           <li><s class="u-menu-icon01" onClick="location.href='/WX/Team/TeamInfo.aspx'"></s><h2>队员</h2></li>
           ...
           <li><a href="/WX/Member/Articles.aspx"><s class="u-menu-icon04"></s><h2>日志</h2></a></li>
       </ul>
    </div>

    <a href="MatchWallet.aspx"><div class="user-item font14 R_jiantou">我的钱包</div></a>
    <div class="user-menu">
       <ul class="fixed">
           ...
           <li><s class="u-menu-icon07"  onClick="location.href='/WX/Fund/Transfers.aspx'"></s><h2>转账</h2></li>
    ...
    <div class="user-menu">
       <ul class="fixed">
           <li><s class="u-menu-icon09" onclick="location.href='/WX/Order/UserOrders.aspx?type=<%= Convert.ToInt32(Enow.TZB.Model.商城订单状态.未支付) %>'"></s><h2>未付</h2></li>
           <li><s class="u-menu-icon10" onclick="location.href='/WX/Order/UserOrders.aspx?type=<%= Convert.ToInt32(Enow.TZB.Model.商城订单状态.已支付) %>'"></s><h2>已付</h2></li>
           <li><s class="u-menu-icon11" onclick="location.href='/WX/Order/UserOrders.aspx?type=<%= Convert.ToInt32(Enow.TZB.Model.商城订单状态.已发货) %>'"></s><h2>发货</h2></li>
           <li><s class="u-menu-icon12" onclick="location.href='/WX/Order/UserOrders.aspx?type=<%= Convert.ToInt32(Enow.TZB.Model.商城订单状态.退款) %>'"></s><h2>退款</h2></li>
       </ul>
    </div>
    ...
    <div class="user-menu">
       <ul class="fixed">
           <li><a href="SiteList.aspx"><s class="u-menu-icon13"></s><h2>场地</h2></a></li>
           <li><a href="ActivityList.aspx?type=2"><s class="u-menu-icon14"></s><h2>培训</h2></a></li>
           <li><a href="ActivityList.aspx?type=3"><s class="u-menu-icon15"></s><h2>聚会</h2></a></li>
           <li><a href="ActivityList.aspx?type=4"><s class="u-menu-icon16"></s><h2>见面会</h2></a></li>
       </ul>
    </div>
