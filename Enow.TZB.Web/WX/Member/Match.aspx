...
<div class="search_head">
   ...
   <asp:TextBox ID="txtKeyWords" runat="server" CssClass="input_txt floatL" Text="赛事搜索" onfocus="if(this.value=='赛事搜索'){this.value='';}" onBlur="if(this.value==''){this.value='赛事搜索';}"></asp:TextBox><asp:Button
