...
<div style="height:64px; position:fixed; top:0; left:0;width:100%;" class="head">
    <a href="/WX/Member/"><b class="icon_home"></b></a>
    <h1>我的义卖商品</h1>
...
<div class="search_head juhui_search" >
   <div class="search_form" style="padding: 0px;width: 80%;">
      <input type="text" name="txtKeyWord" runat="server" id="txtKeyWord" placeholder="商品搜索" class="input_txt floatL" />
