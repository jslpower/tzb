<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageUnRead.aspx.cs" Inherits="Enow.TZB.Web.WX.Member.MessageUnRead" %>
        ...
        function pullUpAction() {
            setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
                ...
                if (pageEnd == "0") {
                    ...
                    $.ajax({
                        type: "Get",
                        url: "/CommonPage/AjaxMessageUnReadList.aspx?" + $.param(para),
                        cache: false,
...
<body>
    ...
    <uc1:UserHome ID="UserHome1" Userhometitle="未读消息" runat="server" />
<div class="warp">
  <div class="msg_tab"  id="n4Tab">
        ...
        <div class="TabTitle">
           <ul class="fixed">
              ...
              <li class="active"><a href="MessageUnRead.aspx">未读</a></li>
