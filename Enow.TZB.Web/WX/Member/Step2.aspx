<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step2.aspx.cs" Inherits="Enow.TZB.Web.WX.Member.Step2" %>
                        ...
                        <ul>
                            ...
                            <li>
                                <label>
                                    ...
                                    ErrorMessage="请填写真实姓名">*</asp:RequiredFieldValidator></li>
                            <li>
                                <label>
                                    ...
                                    ErrorMessage="请填写身份证号码！">*</asp:RequiredFieldValidator></li>
                            <li>
                                <label>
                                    ...
                                    ErrorMessage="请填写通讯地址！">*</asp:RequiredFieldValidator></li>    
                        </ul>
                    </div>
                    <div class="msg_btn">
