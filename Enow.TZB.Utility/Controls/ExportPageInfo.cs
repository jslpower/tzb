...
namespace Enow.TZB.Utility.ExportPageSet
{
	...
	public class ExportPageInfo : System.Web.UI.WebControls.WebControl
	{
		...
		protected override void Render(HtmlTextWriter output)
		{
			...
			if(intPageCount>0)
			{
                retval = "每页 " + _intPageSize + " 条/共 " + _intRecordCount + " 条记录 |  第 " + _CurrencyPage.ToString() + " 页/总 " + intPageCount.ToString() + " 页 ";
                retdropval.Append("每页 " + _intPageSize + " 条/共 " + _intRecordCount + " 条记录 |  第<font color=\"green\">" + _CurrencyPage.ToString() + "</font>/<font color=\"red\">" + intPageCount.ToString() + "</font>页 ");
			}
			else
			{
                retval = "每页 " + _intPageSize + " 条/共 " + _intRecordCount + " 条记录 |  第 " + _CurrencyPage.ToString() + " 页/总 1 页 ";
                retdropval.Append("每页 " + _intPageSize + " 条/共 " + _intRecordCount + " 条记录 |  第<font color=\"green\">" + _CurrencyPage.ToString() + "</font>页/总<font color=\"red\">1</font>页 ");
			}
			retval3 = retval;
