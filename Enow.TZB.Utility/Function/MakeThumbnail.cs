...
namespace Enow.TZB.Utility
{
	...
	public class Thumbnail
	{
        ...
        /// <param name="height">缩略图高度</param>
        /// <param name="mode">生成缩略图的方式</param>    
        public static void MakeThumbnail(System.IO.Stream originalImage, string thumbnailPath, int width, int height, ThumbnailModel mode)
        {
        ...
        /// <param name="height">缩略图高度</param>
        /// <param name="mode">生成缩略图的方式</param>    
        public static void MakeThumbnail(System.Drawing.Image originalImage, string thumbnailPath, int width, int height, ThumbnailModel mode)
        {
            int towidth = width;
            int toheight = height;
