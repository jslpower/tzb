        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            switch (getType)
            {
                case "g":
                    ...
                    IList<Enow.TZB.BLL.tbl_SysCountry> gList = Enow.TZB.BLL.BMSysProvince.GetWxCountryList();
                ...
                case "p":
                    ...
                    IList<Enow.TZB.BLL.tbl_SysProvince> pList = Enow.TZB.BLL.BMSysProvince.GetWxProvinceList(new Enow.TZB.Model.MProvinceSearch { CountryId = gID });
                ...
                case "c":
                    ...
                    IList<Enow.TZB.BLL.tbl_SysCity> cList = Enow.TZB.BLL.BMSysProvince.GetWxCityList(new Enow.TZB.Model.MCitySearch { ProvinceId = pID });
                ...
                case "x":
                    IList<Enow.TZB.BLL.tbl_SysArea> xList = Enow.TZB.BLL.BMSysProvince.GetWxAreaList(new Enow.TZB.Model.MAreaSearch { CityId = cID });
