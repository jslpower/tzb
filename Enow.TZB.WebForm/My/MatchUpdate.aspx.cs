    ...
    public partial class MatchUpdate : System.Web.UI.Page
    {
        ...
        protected void InitOperation(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                else
                {
                    ...
                    {
                        ltrOperation.Text = string.Format("<input type=\"checkbox\" id=\"cbSelect\" name=\"cbSelect\" class=\"join\" dataroletype=\"{1}\" dataId=\"{0}\" checked=\"checked\"><input type=\"hidden\" id=\"hidTMId\" name=\"hidTMId\" value=\"{0}\" />", row.MemberId, row.RoleType);
                    ...
                    {
                        ltrOperation.Text = string.Format("<input type=\"checkbox\" id=\"cbSelect\" name=\"cbSelect\" class=\"join\" dataroletype=\"{1}\" dataId=\"{0}\"><input type=\"hidden\" id=\"hidTMId\" name=\"hidTMId\" value=\"0\" />", row.MemberId, row.RoleType);
                    }
                }
            }
        }
        ...
        private void Save()
        {
            ...
            else
            {
                ...
                var MemberModel = BMember.GetModel(AuthModel.Id);
                if (MemberModel == null)
                {
