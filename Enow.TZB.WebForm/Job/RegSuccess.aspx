<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegSuccess.aspx.cs" Inherits="Enow.TZB.WebForm.Job.RegSuccess" %>
...
<uc2:menu ID="menu1" runat="server" />
    ...
    <div class="warp">
        <div class="reg_form">
            <div class="reg_ok">
                <div class="tishi">
                    <img src="/images/reg_ok.gif">&nbsp;申请成功，</div>
                <div class="reg_txt mt10">
                    请耐心等待审核<em id="emtime">5</em> 秒后跳转到首页<a href="/Default.aspx">立即跳转</a></div>
            </div>
        </div>
    </div>
