<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="Enow.TZB.WebForm.News.NewsList" %>
                ...
                <div class="news">
                    <ul>
                        <asp:Repeater ID="rptNewsList" runat="server">
                            <ItemTemplate>
                                <li><a href="NewsDetail.aspx?id=<%#Eval("id")%>&ClassId=<%=ClassId %>&HmId=<%=HmId %>">
