<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TZList.aspx.cs" Inherits="Enow.TZB.WebForm.News.TZList" %>
            ...
            <div class="left_nav">
                <ul>
                    ...
                    <li><a href="AboutUs.aspx?Id=79&HmId=1">管理团队</a></li>
                     ...
                     <li><a href="TZList.aspx" class="on">堂主风采</a></li>
                ...
                <div class="news">
                    <ul>
                        <asp:Repeater ID="rptNewsList" runat="server">
                            <ItemTemplate>
                                <li><a href="TZDetail.aspx?id=<%#Eval("id")%>&ClassId=19&HmId=<%=HmId %>">
