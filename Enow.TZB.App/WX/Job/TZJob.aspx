<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TZJob.aspx.cs" Inherits="Enow.TZB.Web.WX.Job.TZJob" %>
        ...
        function pullUpAction() {
            setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
                ...
                if (pageEnd == "0") {
                    ...
                    if (KeyWord == "")
                        KeyWord = "";
                    var para = { KeyWord: KeyWord, Page: index, types: <%=(int)Enow.TZB.Model.EnumType.JobType.堂主 %> };
                    $.ajax({
                        type: "Get",
...
<body>
    ...
    <div class="TabTitle" style=" margin-top:50px;">
                <ul class="fixed">
                    <li id="n4Tab_Title0" ><a href="DZJob.aspx">舵主</a></li>
                    <li id="n4Tab_Title1" class="active" ><a href="TZJob.aspx">堂主</a></li>
                    <li id="n4Tab_Title2" ><a href="ZZJob.aspx">站长</a></li>
                </ul>
            </div>
    <uc1:UserHome ID="UserHome1" Userhometitle="堂主报名" runat="server" />
