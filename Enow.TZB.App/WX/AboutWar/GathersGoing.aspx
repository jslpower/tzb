<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GathersGoing.aspx.cs" Inherits="Enow.TZB.Web.WX.AboutWar.GathersGoing" %>
        ...
        function pullUpAction() {
            setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
                ...
                if (pageEnd == "0") {
                    ...
                    $.ajax({
                        type: "Get",
                        url: "/CommonPage/AjaxGathersGoing.aspx?" + $.param(para),
                        cache: false,
