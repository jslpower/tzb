<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacePayStep1.aspx.cs" Inherits="Enow.TZB.Web.WX.Fund.FacePayStep1" %>
...
<div class="warp">
  <div class="msg_tab"  id="n4Tab">
        ...
        <div id="n4Tab_Content1">
                ...
                <div class="msg_btn">
                    <asp:Button ID="btnSave" runat="server" CssClass="basic_btn" Text="确  认" 
