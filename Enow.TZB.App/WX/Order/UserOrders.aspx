	...
	generatedCount = 0;
        ...
        function pullUpAction() {
            setTimeout(function () {	// <-- Simulate network congestion, remove setTimeout from production!
                ...
                if (pageEnd == "0") {
                    $("#pageindex").val(index);
                    var para = { Page: index, type: types };
                    $.ajax({
                        type: "Get",
...
<div class="user_warp paddB10" >
    ...
    <div class="u-dindan-list" id="wrapper" style=" margin-top:110px;">
       ...
       <asp:Repeater ID="rptList" runat="server" onitemdatabound="HandleOperation">
              <ItemTemplate>
           <li>
           <div class="user-item font14 R_jiantou" onclick="location.href='UserOrdersDetail.aspx?addr=<%#Eval("AddressId")%>&no=<%#Eval("OrderNo")%>&OrderId=<%#Eval("OrderId")%>&total=<%=total%>'"><%#Eval("OrderNo")%></div>
